(function exportToWindow() {
    ...
    class Map {
        ...
        setTraps() {
            ...
            let trapPositions = [];
            path.forEach(id => {
                let pos = this.graph.nodes[id].pos; //REMOVED QUESTION MARK FROM BEGINNING OF .POS
                if(!pos)
                    return;
    ...
    class MapConfig {
        ...
        constructor(dimensions, maxTunnels, maxLength, trapNumber) { //REMOVED OBJECT FROM PARAMETERS
